  ...
  var jokes = [
    ...
    "You gotta get those fingers to the gym asap my home skillet biscuit! You too slow!",
    "You've got some supreme slowness in them there fingers boy! You gotta do some finger cardio!",
    "Check the mail! We sent you $1. One million is for winners!",
  ];
...
var bubble = document.querySelector(".bubbles")
